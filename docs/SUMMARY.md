...
* [BIC Facility Code](bic-facility-code/README.md)
  * [API](bic-facility-code/api.md)
  * [Alias Codes](bic-facility-code/alias-codes.md)
  * [FAQ](bic-facility-code/faq.md)

## Global Container Geofence Library

* [Introduction](global-container-geofence-library/introduction.md)
* [Register as Contributor](global-container-geofence-library/registration.md)
* [Submit a Geofence Request](global-container-geofence-library/submit-a-geofence-request.md)

## Geofencing Best Practice

* [Defining Geofences](geofencing-best-practice/geofence-library.md)
* [Drawing and Reviewing Geofences](geofencing-best-practice/drawing-and-reviewing-geofences/README.md)
  * [Boundary Rule Examples](geofencing-best-practice/drawing-and-reviewing-geofences/boundary-rule-examples.md)
  * [Gate Examples](geofencing-best-practice/drawing-and-reviewing-geofences/gate-examples.md)
